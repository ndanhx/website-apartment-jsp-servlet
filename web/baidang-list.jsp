    ...
    <head>
        ...
        <style>
            ...
            .pop .inn {
                ...
                max-width: 600px; /* Giới hạn chiều rộng tối đa của form */
                height: 90%; /* Thay đổi chiều cao của form */
                max-height: 300px; /* Giới hạn chiều cao tối đa của form */
                overflow-y: auto; /* Bật thanh cuộn để tránh lỗi tràn nội dung */
            }
            .btn-hideform {
                margin-top: 40px;
...
">
            ...
            <div class="select-trangthai">
                <div>
                    <label class = "lb-search">Tìm kiếm bài đang theo trạng thái:</label>
                    <select id="trangthai" name="trangthai" aria-label=".form-select-lg" onchange="changeStatus(this)";>
            ...
            <script>
                function changeStatus(valueop) {
                    $.ajax({
                        type: "GET",
                        url: "/DangTinThueDangHo/ApartmentWithStatus",
                        data: {
                            status: valueop.value
                        },
                        success: function (data) {
                            var postData = document.getElementById("dataShow");
                    ...
                    <c:forEach var="o" items="${getall}">
                        <tr >
                            ...
                            <td>
                                ...
                                <c:if test="${o.getTrangThai() == 0 }">
                                    <a class="btn btn-success" href="#" onclick="togglePopup_dangtin(${o.getIdBaidang()},${o.getIdCanHo()})"> Accept</a>
                                </c:if>
            ...
            <div class="pop" id="myPopup_dangtin" >
               ...
               <!--pop up edit tieu de bai dang-->
             <div class="pop" id="myPopup_baidang" >
                <div class="inn" >
                    <h2 class="text-center">Chỉnh sửa thông tin bài đăng</h2>
                    <form action="edit-listing" method="post">
                        <hr>
                        <fieldset class="form-group">
                            <label>ID bài đăng</label> 
                            <input type="text" class="form-control" readonly="true" value="" id="idbaidang_edit"
                                   name="idbaidang"  >
                        </fieldset>
                        <fieldset class="form-group">
                            <label>Tiêu đề bài đăng</label>
                            <input type="text" class="form-control" 
                                  id="tieu_de" name="tieu_de"  value="" required="required">
                        </fieldset>
                ...
                <script>
                    ...
                    function myPopup_baidang(idbaidang,tieude) {
                        var popup = document.getElementById("myPopup_baidang");
                        popup.style.display = "block";

                        var inputIdbaidang = document.getElementById("idbaidang_edit");
                        inputIdbaidang.value = idbaidang;
                      //  console.log(">>>", idbaidang)
                        var inputtieudebaidang = document.getElementById("tieu_de");
                        inputtieudebaidang.value = tieude;
