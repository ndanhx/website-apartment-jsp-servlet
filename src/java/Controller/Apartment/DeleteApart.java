 ...
 * @author Home
 */
@WebServlet(name = "DeleteApart", urlPatterns = {"/DeleteApart"})
public class DeleteApart extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        if (check > 0) {
            ...
            List<CanHo> getall = chDAO.getAllCanHo();
            ...
            request.getRequestDispatcher("apart-list.jsp").forward(request, response);
        } else if (check <= 0) {
            CanHoDAO chDAO = new CanHoDAO();
            List<CanHo> getall = chDAO.getAllCanHo();
            DiaChiDAO diachiD = new DiaChiDAO();
