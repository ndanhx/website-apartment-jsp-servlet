 ...
 * @author Home
 */
@WebServlet(name = "SearchAjax4", urlPatterns = {"/SearchAjax4"})
public class SearchAjax4 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        String id_phuong=request.getParameter("id_phuong");
        ...
        for(BaiDang o : listch){
            ...
            CanHo ch = canhodao.getCanHo_ByIDPhuong(o.getIdCanHo(), id_phuong);
            if(ch != null){
            count++;
